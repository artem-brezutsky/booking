...
(function (global, factory) {
    ...
    */
    ...
    function isDateSelectionPropsValid(state, calendar, dateSpanMeta, filterConfig) {
        ...
        //@fixme unselect if start day != end day
        var endDate = new Date(selectionRange.end);
        endDate.setUTCSeconds(selectionRange.end.getUTCSeconds() - 1);
        if (endDate.getUTCDate() !== selectionRange.start.getUTCDate()) {
            return false;
        }
